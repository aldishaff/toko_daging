...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> tgl pesanan : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <p> pesananmu : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> total harga : <span>Rp<?php echo $fetch_orders['total_price']; ?>,00</span> </p>
      ...
      <?php
         ...
         echo '<p class="empty">Tidak ada pesanan disini!</p>';
      }
      ?>
   </div>
